...
public class PopUpAlterar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 1));
        ...
        jButton2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 1));
        // Nenhum ActionListener padrão aqui — o controller adiciona o seu próprio
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpAlterar.class.getName())
