...
public class PopUpDeleteQuiz extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tem certeza que deseja escluir esse Quiz?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpDeleteQuiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopUpDeleteQuiz dialog = new PopUpDeleteQuiz(new javax.swing.JFrame(), true);
